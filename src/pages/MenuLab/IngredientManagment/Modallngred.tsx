        ...
        <div className="fixed inset-0 bg-[#1E1E1E] bg-opacity-30 flex justify-center items-center z-50">
            <div className="bg-[#F1FCF1] p-6 rounded-3xl shadow-lg w-[700px] h-[423px] relative">
                ...
                {inputFields.map((input, index) => (
                    <div key={index} className="w-[365px] h-[40px] text-[#066426] flex justify-between items-center justify-self-center font-medium mb-5">
                        <div>{input.label}</div>
                        <input
                            type="text"
                ...
                <div className="justify-self-center">
                    <button onClick={handleSubmit} className="mt-6 w-[134px] h-[48px] bg-[#30E06C] text-[#1E1E1E] py-2 rounded-full hover:bg-white hover:text-[#066426] hover:border hover:border-[#30E06C]">
                        Submit
                    </button>
                </div>
            </div>
