    ...
    return (
        <div className="fixed inset-0 bg-[#1E1E1E] bg-opacity-30 flex justify-center items-center z-50">
            <div className="bg-[#F1FCF1] p-6 rounded-3xl shadow-lg w-[700px] h-[729px] relative">
                ...
                <img src={menu?.image} alt={menu?.name} className="w-[200px] h-[200px] mx-auto" />
                <div>
                    {menu?.Description}
                </div>
                ...
                {menu?.ingredients.map((ingredient, index) => (
                    <div className='w-[500px] grid grid-cols-4 mb-2 font-medium justify-self-center text-[#386C5F]' key={index}>
