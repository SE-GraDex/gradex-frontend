...
const ModalNewMenu: React.FC<MealPrepModalProps> = ({ isOpen, onClose }) => {
        ...
        <div className="fixed inset-0 bg-[#1E1E1E] bg-opacity-30 flex justify-center items-center z-50">
            <div className="bg-[#F1FCF1] p-6 rounded-3xl shadow-lg w-[700px] h-[828px] relative">
                ...
                <div className='flex justify-center items-center mb-4'>
                    ...
                    <input
                        type="text"
                        className="w-[215px] h-[40px] rounded-lg border border-[#066426] pl-3 outline-none"
                ...
                <div className='flex justify-center items-center mb-4'>
                    ...
                    // onChange={(e) => handleChange(e, 'ingredientName')}
                    />
                    <img src={addcircle} alt="" className='w-[25px] h-[25px]' />   
                </div>
