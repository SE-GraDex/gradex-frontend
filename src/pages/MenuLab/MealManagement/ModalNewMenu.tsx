...
const ModalNewMenu: React.FC<MealPrepModalProps> = ({ isOpen, onClose, onSubmit }) => {
  ...
  const ShowAllvalue = () => {
    const newMenu: MenuItem = {
      name: nameMenu,
      image: fileName ? URL.createObjectURL(fileName) : '',
    ...
    axiosInstance
      .post('/api/menu/createMenu', formData, {
        headers: {
  ...
  useEffect(() => {
    axiosInstance
      .get('/api/ingredient/getIngredients')
      .then((res) => {
        ...
        <div className="text-[#066426]">
          ...
          <div className="w-[341px] justify-self-center flex justify-between items-center mb-4">
            ...
            <label className="file-input-container ">
              <span className="file-name">{fileName ? fileName.name : ''}</span>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                {!fileName ? (
                  <path
