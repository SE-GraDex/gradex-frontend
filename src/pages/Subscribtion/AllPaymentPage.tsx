  ...
  return (
    <div className="">
      <div className="w-[1120px] h-[170px] justify-self-center mb-10">
        <div className="text-5xl font-bold text-[#386C5F] mt-10">Payment</div>
        <div className="text-2xl text-[#386C5F] mt-3">Payment methods</div>
          ...
          <div>
            <div className="flex gap-10">
              <div
                className={
                  showCreditCardPayment
                    ? 'bg-[#30E06C] w-[120px] h-[80px] rounded-xl flex items-center justify-center'
                    : 'w-[120px] h-[80px] flex items-center justify-center hover:cursor-pointer'
                }
                onClick={() => {
                  setShowCreditCardPayment(!showCreditCardPayment)
              ...
              <div
                ...
                onClick={() => {
                  setShowQRCodePayment(!showQRCodePayment)
            ...
            {showQRCodePayment && (
              <>
                <div className="text-[#386C5F] text-xl">Scan to Pay</div>
