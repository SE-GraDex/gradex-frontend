      ...
      <div className="justify-self-center flex">
        ...
        <div className="grid-cols-3 flex mt-6">
          <div className="bg-[#7BB3B5] w-[125px] h-[440px] rounded-tl-3xl">
            ...
            <div className="justify-self-center text-[20px] font-medium mt-6 text-white w-[20px] h-[20px] text-center">
              -
            </div>
            <div className="justify-self-center text-[20px] font-medium mt-6 text-white w-[20px] h-[20px] text-center">
              -
          ...
          <div className="bg-[#5E8D97] w-[125px] h-[440px]">
            ...
            <div className="justify-self-center text-[20px] font-medium mt-4 text-white w-[20px] h-[20px] text-center">
              -
            </div>
