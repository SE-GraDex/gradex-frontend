  ...
  return (
    <div>
      ...
      <div className="w-[729px] mt-10 flex justify-end">
        <button
          className="border w-[126px] h-[48px] border-[#30E06C] hover:bg-[#30E06C] rounded-full px-4 py-3 hover:text-black bg-[#C6FFEA] transition-all text-[#066426] duration-200 "
