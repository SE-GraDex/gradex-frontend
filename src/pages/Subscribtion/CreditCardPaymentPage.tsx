    ...
    <div>
        ...
        <form className="grid gap-4">
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input type="text" className="w-[301px] h-[52px] p-2 border border-gray-300 rounded-2xl" />
            </div>
            <div>
              <label className="block text-[#066426] font-medium">Card Number</label>
              <input type="text" className="w-[226px] h-[52px] p-2 border border-gray-300 rounded-2xl" />
            </div>
            <div>
          ...
          <div className="flex gap-10">
            ...
            <div>
              ...
              <input type="text" className="w-[142px] h-[52px] p-2 border border-gray-300 rounded-2xl" />
            </div>
            <div>
      ...
      <div className="w-[1120px] justify-self-center text-end mt-6">
        <div className="text-4xl font-bold">
          ...
          {selectedPackage === 'Basic' ? 180 : selectedPackage === 'Deluxe' ? 250 : 350} Bath
        </div>
        <div className="mt-6 flex space-x-4 justify-end">
          <button
            className="border w-[126px] h-[48] border-[#30E06C] bg-[#30E06C] rounded-full px-4 py-3 text-black hover:bg-[#C6FFEA] transition-all duration-200"
            onClick={() => setIsPopUpOpen(true)}
          >
            Confirm
          </button>
          <button
            className="border w-[126px] h-[48] border-[#30E06C] hover:bg-[#30E06C] rounded-full px-4 py-3 hover:text-black bg-[#C6FFEA] transition-all text-[#066426] duration-200"
      ...
      {isPopUpOpen && (
        <ModelPayment isOpen={isPopUpOpen} onClose={() => setIsPopUpOpen(false)} menuType={selectedPackage} />
      )}
    </div>
  )
}
