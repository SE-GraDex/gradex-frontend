...
const MonthSelector: React.FC<{ onMonthChange: (month: string) => void }> = ({ onMonthChange }) => {
  ...
  return (
    <div className="w-[368px] h-[50px] flex items-center mt-7 mb-7">
      ...
      <button onClick={toggleDropdown} className="ml-auto bg-green-400 p-2 rounded-r-3xl w-[95px] h-[50px] ">
        <svg
  ...
  return (
    <div className="flex justify-center mt-10 space-x-16 ">
      <div className="justify-self-center">
        ...
        <CalendarTest
          isToggle={toggle}
          isMonthSelectorOpen={months.indexOf(selectedMonth)}
        ...
        <div className="flex flex-row justify-self-center items-center justify-center mt-4 space-x-3">
          ...
          <div
            className="w-[30px] h-[30px] text-[#C6FFEA] bg-[#066426] rounded-full text-xl flex justify-center items-center hover:cursor-pointer"
            title="จะ filled ทุกวันที่ให้มีเมนูอาหารครบทุกวัน"
          >
            i
          </div>
        </div>
