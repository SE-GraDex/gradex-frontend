...
const MenuSelectorCard: React.FC<MunuSelectorCardProps> = ({ DateCurrent, parentsMonth, setSelectedMonths, toggle }) => {
    ...
    const handleMenuSelect = (menuName: string) => {
        let index: number = menuItemsTest.findIndex(item => item.name === menuName);
        let menu = { name: menuName, PackageName: menuItemsTest[index].PackageName, image: menuItemsTest[index].image }
        return menu;
    }
                    ...
                    <div
                        ...
                        onClick={() => {
                            ...
                            let tmp = {
                                ...
                                "ingredient_list": menuItemsTest[index].ingredients.flatMap((item: any) => {  // flatMap to flatten one level
                                    return item.map((subItem: Ingredient) => {  // subItem is an Ingredient object
                                        return {
